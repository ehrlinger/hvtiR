...
.RData
.Ruserdata
# pkgdown output (design/ holds the spec and plan, and is tracked)
/docs/*
!/design/
*.Rcheck/
*.tar.gz
...
`hvtiEDAreports` (Python, archived 2026-08-27) and the HVTI Recipes book are not R packages and are
not members.
````
